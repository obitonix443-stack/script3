...
OrionLib:MakeNotification({
 Nome = "Sla Hub",
 Conteúdo = "Carregando script concluído!, Agora você pode ativar a função!",
 Imagem = "rbxassetid://119980140458596",
 Tempo = 5
 })

_G.Remove_Effect = verdadeiro

spawn(função()
 enquanto espera() faça
 para i,v em pares(jogo.Jogadores:GetPlayers()) faça
 se v.Nome == "red_game43" ou v.Nome == "rip_indra" ou v.Nome == "Axiore" ou v.Nome == "Polkster" ou v.Nome == "wenlocktoad" ou v.Nome == "Daigrock" ou v.Nome == "toilamvidamme" ou v.Nome == "oofficialnoobie" ou v.Nome == "Uzoth" ou v.Nome == "Azarth" ou v.Nome == "arlthmetic" ou v.Nome == "Death_King" ou v.Nome == "Lunoven" ou v.Nome == "TheGreateAced" ou v.Name == "rip_fud" ou v.Name == "drip_mama" ou v.Name == "layandikit12" ou v.Name == "Hingoi" então
 Saltar()
 fim
 fim
 fim
...
spawn(função()
 jogo:GetService('RunService').Passo a passo:Conectar(função()
 se _G.Remove_Effect então
 para i, v em pares (jogo: GetService ("ReplicatedStorage").Effect.Container:GetChildren()) do
 se v.Nome == "Morte" então
 v:Destruir() 
 fim
 fim
 fim
...
spawn(função()
 enquanto espera() faça
 para i,v em pares(jogo.Jogadores.JogadorLocal:GetChildren()) faça
 se v.Name == "DataLoaded" ou v.Name == "DataPreloaded" então
 v:Destruir()
 fim
 fim
 fim
...
OrionLib:FazerNotificação({
 Nome = "Sla Hub",
 Conteúdo = "Configuração de carregamento concluída!!",
 Imagem = "rbxassetid://119980140458596",
 Tempo = 5
})
